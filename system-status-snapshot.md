...
---
_Auto update: 2026-03-05 15:43:06_

### Health check summary

```
staging: HTTP 403 (230 ms, fail) – https://www.sharity.hu/impactshop-staging/wp-json/
production: HTTP 403 (256 ms, fail) – https://app.sharity.hu/wp-json/
```
