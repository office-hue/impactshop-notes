...
.impactshop-vote__step { display: inline-flex; align-items: center; gap: 6px; padding: 6px 10px; border-radius: 999px; font-size: 12px; font-weight: 600; background: rgba(148, 163, 184, 0.2); color: #e2e8f0; }
...
function impactshop_vote_jysk_shortcode(): string
{
    ...
    $html .= '<div class="impactshop-vote__step is-active" data-step="1"><span class="impactshop-vote__step-dot"></span>Videó</div>';
    $html .= '<div class="impactshop-vote__step" data-step="2"><span class="impactshop-vote__step-dot"></span>Szervezet</div>';
    $html .= '<div class="impactshop-vote__step" data-step="3"><span class="impactshop-vote__step-dot"></span>Szavazás</div>';
    $html .= '</div>';
    ...
    $html .= '<div class="impactshop-vote__video" data-role="video-wrap"></div>';
    ...
    $html .= '<div data-role="progress-text">Videó megtekintése szükséges a szavazathoz.</div>';
    ...
    $html .= '</div>';
    $html .= '</div>';
    $html .= '<div class="impactshop-vote__ngos" data-role="ngo-list"></div>';
    ...
    $html .= '<button type="button" data-role="vote-submit" disabled>Szavazok most</button>';
