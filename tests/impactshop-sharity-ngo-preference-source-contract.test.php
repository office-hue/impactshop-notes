...
assert(sharity_ngo_pref_redeem_code($codes, str_repeat('D', 32), 'grant', 'bff-prod', 'https://bff.example/callback', 'verifier', true, 20) === 'v1:subject');
...
assert(sharity_ngo_pref_cas_update($preferences, $idempotency, $audit, 'v1:subject', 'profile_default', 1, $revision, $revision, $master, $policy, 0, 'op-1', 21) === 'idempotency_conflict');
