...
| 2026-09-10 | Sharity staging CAS current-main repin | Maximum-protected source metadata binds the future CAS manifest derived from `origin/main@9d351cd`; provider, VPS, database and runtime authority remain denied. | `docs/protected-change-records/2026-09-10-sharity-profile-staging-cas-current-main-repin.md` |
