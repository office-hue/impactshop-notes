...
| 2026-09-10 | Sharity staging CAS current-main repin | Maximum-protected source metadata binds the future CAS manifest/checksum blobs `0e5fcc5d` / `e2f7620e`, derived from `origin/main@44547312`; provider, VPS, database and runtime authority remain denied. | `docs/protected-change-records/2026-09-10-sharity-profile-staging-cas-current-main-repin.md` |
