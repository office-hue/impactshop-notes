...
| Sharity Profile owner-grant lane | `docs/sharity-profile-sp1-owner-grant-sol-decision-2026-09-09.md` | `wp-content/mu-plugins/impactshop-identity-panel.php`, `wp-content/mu-plugins/impactshop-identity-panel.js`, `wp-content/mu-plugins/impactshop-adsense-head.php` | `tests/impactshop-identity-profile-v2-static.test.py`, `docs/sharity-profile-sp1-terra-qa1-2026-09-09.md`, `docs/protected-change-records/2026-09-09-sharity-profile-owner-grant.md` | protected inventory/digest, guarded source publication, exact-file staging/production lane | `docs/sharity-profile-sp1-luna-continuity-2026-09-09.md`, `docs/sharity-profile-sp1-sol-release-gate-2026-09-09.md`, `notes.md`, `system-status-snapshot.md`, `docs/bastion-guard-status.md` | `source-reviewed` | Owner grant, code reveal and account-switch revocation are source-reviewed. Live schema/browser E2E and the remaining direct pseudo-cookie mutators block production acceptance. No cron/watchdog. |
