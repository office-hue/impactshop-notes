...
|---|---|---|---|---|---|---|---|
| Local governance control plane | `docs/impactshop-governance-system-plan-2026-06-16.md` | `AGENTS.md`, `docs/pr-policy.md`, `PR-EXIT-CHECKLIST.md`, `docs/ai-assistant-canonical-policy.md`, `scripts/start-feature-worktree.sh`, `scripts/worktree-task-start.sh`, `scripts/worktree-task-start-guard.sh`, `scripts/worktree-readiness-check.sh`, `scripts/worktree-coordination-sync.sh`, `scripts/worktree-continuity-guard.sh`, `scripts/guarded-push.sh`, `scripts/install-hooks.sh` | `docs/impactshop-governance-hub-coherence-audit-2026-06-16.md`, `docs/worktree-coordination-sync.md`, `docs/worktree-continuity-guard.md`, `tests/worktree-multi-active-continuity.test.sh` | `scripts/safe-repo-audit.sh --strict --mode push`, `scripts/git-health-check.sh`, repo-local worktree readiness/task-start/coordination/continuity guards, workspace `.worktrees/ACTIVE_WORKTREE.md`, workspace `.worktrees/ACTIVE_WORKTREES.md`, per-worktree `worktree-task-start-decision.json` | `docs/impactshop-multi-active-continuity-sol-continuity-2026-09-10.md`, `notes.md`, `system-status-snapshot.md`, `docs/bastion-guard-status.md` | `source-candidate` | Multi-active source contract: registration preserves the explicit primary; generation-bound snapshots carry exact full-HEAD/clean/decision truth for every publisher. Non-primary publish is reviewer-visible degraded, while stale, dirty, generation-drift and lock races fail closed. The lane is repo-local and never calls a sibling `ai-agent` worktree or shared Node dependency tree. |
