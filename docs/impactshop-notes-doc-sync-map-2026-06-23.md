...
LastVerifiedAt: `2026-08-19T15:50:00Z`
...
| Deploy bastion manifest és true dry-run | `docs/impactshop-deploy-bastion-manifest-sol-plan-2026-08-19.md` | `bin/deploy-wpcontent-map.sh`, `bin/impactshop-guard-deploy.sh` | `tests/deploy-wpcontent-map-bastion.test.sh`, `docs/protected-change-records/2026-08-19-deploy-bastion-manifest-guard.md` | remote manifest fail-closed admission, no-write itemized `DRY_RUN=1`, protected-touch és strict audit | `docs/impactshop-deploy.md`, `notes.md`, `system-status-snapshot.md`, `docs/bastion-guard-status.md` | `partial` | A guard source checkpoint készül; real deploy a staging 404 és a live-main identity drift rendezéséig tiltott. |
