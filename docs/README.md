...
- `docs/partner-install-guides.md`
- `docs/partner-pilot-tests.md`
- `docs/partner-demo-scenario.md`
- `docs/partner-docs-site.html`

## Egyéb kulcs dokumentumok
- `docs/impactshop-system-map.md`
- `docs/impactshop-ngo-card-usage.md`
- `docs/fiok-pontrendszer-spec.md`
...
- `tools/hmac-sign.js`
- `tools/hmac-sign.md`
- `tools/partner-test-runner.cjs`
- `tools/partner-test-runner.md`
- `tools/partner-qa.cjs`
- `tools/partner-qa.md`
