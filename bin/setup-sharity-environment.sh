...
echo "Home : $HOME_DIR"
echo "Staging URL   : https://app.sharity.hu/impactshop-staging"
echo "Production URL: https://app.sharity.hu/impactshop"
...
export STAGING_URL="https://app.sharity.hu/impactshop-staging"
...
export STAGING_URL="https://app.sharity.hu/impactshop"
export CPANEL_MODE="true"
export CPANEL_USER="$CPANEL_USER"
export CPANEL_HOST="$CPANEL_HOST"
export HOME_DIR="$HOME_DIR"
