...
repo_root = os.path.dirname(os.path.dirname(os.path.abspath(hash_path)))
display_path = os.path.relpath(os.path.abspath(hash_path), repo_root)
with open(checksum_path, "w", encoding="utf-8") as fh:
    fh.write(f"{checksum}  {display_path}\n")
